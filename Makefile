...
$(OBJ_DIR)/main.o: $(INCLUDE_DIR)/JogoVelha.hpp $(INCLUDE_DIR)/Ligue4.hpp $(INCLUDE_DIR)/Reversi.hpp $(INCLUDE_DIR)/Admin.hpp $(INCLUDE_DIR)/Jogador.hpp $(SRC_DIR)/main.cpp
	$(CC) $(CFLAGS) -c $(SRC_DIR)/main.cpp -I$(INCLUDE_DIR) -o $(OBJ_DIR)/main.o
main: $(OBJ_DIR)/main.o $(OBJ_DIR)/Ligue4.o $(OBJ_DIR)/JogoVelha.o $(OBJ_DIR)/Reversi.o $(OBJ_DIR)/Admin.o $(OBJ_DIR)/Jogador.o
