...
public:
    ...
    Usuario(std::string nome, std::string apelido, int vitorias, int derrotas, int sequencia) : nome(nome), apelido(apelido), vitorias(vitorias), derrotas(derrotas), sequencia(sequencia){}
    virtual ~Usuario(){};
